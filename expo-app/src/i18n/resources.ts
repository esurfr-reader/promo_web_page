...
export const resources = {
  en: { common: enCommon, hero: enHero, problem: enProblem, flow: enFlow, canvas: enCanvas, features: enFeatures, review: enReview, method: enMethod, cta: enCta },
  es: { common: esCommon, hero: esHero, problem: esProblem, flow: esFlow, canvas: esCanvas, features: esFeatures, review: esReview, method: esMethod, cta: esCta },
  pt: { common: ptCommon, hero: ptHero, problem: ptProblem, flow: ptFlow, canvas: ptCanvas, features: ptFeatures, review: ptReview, method: ptMethod, cta: ptCta },
  ja: { common: jaCommon, hero: jaHero, problem: jaProblem, flow: jaFlow, canvas: jaCanvas, features: jaFeatures, review: jaReview, method: jaMethod, cta: jaCta },
  fr: { common: frCommon, hero: frHero, problem: frProblem, flow: frFlow, canvas: frCanvas, features: frFeatures, review: frReview, method: frMethod, cta: frCta },
} as const;
